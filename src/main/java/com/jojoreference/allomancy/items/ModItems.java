...
import com.jojoreference.allomancy.items.aluminium.AluminiumIngot;
import com.jojoreference.allomancy.items.atium.AtiumIngot;
...
public class ModItems {
    ...
    @ObjectHolder("allomancy:tiningot")
    public static TinIngot TININGOT;

    @ObjectHolder("allomancy:leadingot")
    public static LeadIngot LEADINGOT;

    @ObjectHolder("allomancy:steelingot")
    public static SteelIngot STEELINGOT;

    @ObjectHolder("allomancy:pewteringot")
    public static PewterIngot PEWTERINGOT;

    @ObjectHolder("allomancy:bronzeingot")
    public static BronzeIngot BRONZEINGOT;

    @ObjectHolder("allomancy:zincingot")
    public static ZincIngot ZINCINGOT;

    @ObjectHolder("allomancy:brassingot")
    public static BrassIngot BRASSINGOT;

    @ObjectHolder("allomancy:aluminiumingot")
    public static AluminiumIngot ALUMINIUMINGOT;

    @ObjectHolder("allomancy:atiumingot")
    public static AtiumIngot ATIUMINGOT;
